<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/Users/mmws/work/charge/pyg/pyg/public/../application/home/view/goods/detail.html";i:1563959902;s:65:"/Users/mmws/work/charge/pyg/pyg/application/home/view/layout.html";i:1563701718;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="<?php if((isset($goods['goods_images'][0]['pics_big']))): ?><?php echo $goods['goods_images'][0]['pics_big']; endif; ?>" src="<?php if((isset($goods['goods_images'][0]['pics_sma']))): ?><?php echo $goods['goods_images'][0]['pics_sma']; endif; ?>" /></span>
						</div>
						<!--下方的缩略图-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								<dt>
									<div class="fl title">
										<i><?php echo $v['spec_name']; ?></i>
									</div>
								</dt>
								<?php foreach($v['spec_values'] as $k=>$value): ?>
								<dd><a spec_value_id="<?php echo $value['id']; ?>" href="javascript:;" class="<?php if(($k == 0)): ?>selected<?php endif; ?>"><?php echo $value['spec_value']; ?><span title="点击取消选择">&nbsp;</span></a></dd>
								<?php endforeach; ?>
							</dl>
							<?php endforeach; ?>
						</div>
